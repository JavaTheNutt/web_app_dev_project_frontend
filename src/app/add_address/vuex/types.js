...
export default namespace('add_address', {
  getters: ['getValues', 'getPossibleAddresses', 'getSelectedAddress', 'getRoutePrefix', 'getHasMultipleAddresses'],
  ...
  mutations: ['m_setFormValues', 'm_resetFormValues', 'm_setResults', 'm_resetResults', 'm_setSelectedAddress', 'm_setRoutePrefix', 'm_setHasMultipleAddresses']
})
